...
const SidebarMenuButton = React.forwardRef(
  (
    ...
    if (isCollapsed && React.Children.count(props.children) > 1) {
      const childArray = React.Children.toArray(props.children);
      const textContent =
        childArray.length > 1 && React.isValidElement(childArray[1])
          ? childArray[1].props.children
          : "";

      return (
        <Tooltip>
          <TooltipTrigger asChild>{menuButtonContent}</TooltipTrigger>
